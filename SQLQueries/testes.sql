...
FROM
    OPENROWSET(BULK N'C:\Users\WorkStationW10\Documents\MVR-Casa-Pronta\MVR-Casa-Pronta\images\3.jpg', SINGLE_BLOB) AS IMG_BYTE),
	'teste 3.jpg' ,
	'teste descrição 3.jpg'
	)
...
DELETE FROM Images WHERE IMG_ID > 0
